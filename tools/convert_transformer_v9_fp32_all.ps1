...
# Full FP32 transformer conversion. Use ONLY after v9 FP32 frontend passes the
# on-device numerical test (tools/test_qnn_gpu_frontend.ps1). FP16 MatMul/FC
# overflows to inf/NaN in attention projections on Adreno 830.
...
$outRoot = Join-Path $buildRoot "qnn_transformer_v9_fp32"
...
Write-Host "ALL TRANSFORMER FP32 DONE -> $outRoot"
