...
> **Maintenance disclaimer**: All code in this project was produced through vibe coding (AI-assisted development) and is **not actively maintained**. It is provided as-is for reference only — use at your own risk. No guarantees of correctness, security, or ongoing fixes. **Feel free to fork this project if needed.**
